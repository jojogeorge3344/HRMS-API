  ...
  imports: [
    ...
    RouterModule.forChild([
      ...
      },
      {
        ...
        data: { breadcrumbs: ['Organization', 'Employee', 'Add'], name: 'organization-employeedirectory ' }
      },
      {
        path: ':id/edit/:jobDetailsId/:jobFilingId', component: EmployeeEditContainerComponent,
        data: { breadcrumbs: ['Organization', 'Employee', 'Edit'], name: 'organization-employeedirectory ' }
      },
      {
        path: ':id/edit/:jobDetailsId/:jobFilingId/salary-details/create', component: EmployeeSalaryCreateContainerComponent,
        data: { breadcrumbs: ['Organization', 'Employee', 'Salary', 'Create'], name: 'organization-employeedirectory ' }
      },
      {
        path: ':id/edit/:jobDetailsId/:jobFilingId/salary-details/edit', component: EmployeeSalaryEditContainerComponent,
        data: { breadcrumbs: ['Organization', 'Employee', 'Salary', 'Edit'], name: 'organization-employeedirectory ' }
      },
      {
        path: ':id/view/:jobDetailsId/:jobFilingId', component: EmployeeViewContainerComponent,
        data: { breadcrumbs: ['Organization', 'Employee', 'View'], name: 'organization-employeedirectory ' }
      }    
    ]),
    NgbModule,
    FormsModule,
