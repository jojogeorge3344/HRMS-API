...
@Component({
  selector: 'hrms-payroll-configuration-allowance',
  templateUrl: './payroll-configuration-allowance.component.html'
})
export class PayrollConfigurationAllowanceComponent implements OnChanges {
