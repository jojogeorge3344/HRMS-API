...
export class PayrollComponentService {
  ...
  get(id) {
    return this.http.get<PayrollComponent>(this.baseUrl + "get/" + id).pipe(
      map((response) => {
        return response;
      })
    );
  ...
  getAll() {
    return this.http
      .get<PayrollComponent[]>(this.baseUrl + "getAllOrderByPayrollComponent")
      .pipe(
        map((response) => {
          return response;
        })
  ...
  add(payrollComponent: PayrollComponent) {
    return this.http
      .post<PayrollComponent>(this.baseUrl + "insert", payrollComponent)
      .pipe(
        map((response) => {
          return response;
        })
  ...
  update(payrollComponent: PayrollComponent) {
    return this.http
      .post<PayrollComponent>(this.baseUrl + "update", payrollComponent)
      .pipe(
        map((response) => {
          return response;
        })
  ...
  delete(id: number) {
    return this.http
      .delete<PayrollComponent>(this.baseUrl + "delete/" + id)
      .pipe(
        map((response) => {
          return response;
        })
