...
@Component({
  selector: 'hrms-employee-encashment-edit',
  templateUrl: './employee-encashment-edit.component.html',
  styleUrls: ['./employee-encashment-edit.component.scss'],
  providers: [{ provide: NgbDateAdapter, useClass: NgbDateNativeAdapter },
    {provide: NgbDateParserFormatter, useClass: DateformaterService}],
})
export class EmployeeEncashmentEditComponent implements OnInit {
