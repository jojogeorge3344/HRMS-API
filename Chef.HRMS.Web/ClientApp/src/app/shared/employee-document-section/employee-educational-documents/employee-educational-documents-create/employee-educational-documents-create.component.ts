...
export class EmployeeEducationalDocumentsCreateComponent implements OnInit {
  ...
  onSubmit() {
    ...
    forkJoin([
      ...
      ([education, document]) => {
        ...
        this.educationdocumentService.add(this.educationDocument).subscribe(
          (result: any) => {
          ...
          (error) => {
            ...
            this.toastr.showErrorMessage(
              "There is an error in adding Education Details"
            );
          }
        );
      },
  ...
  setMaxDate() {
    this.maxDate = {
      year: new Date(
        this.addForm.controls["yearOfCompletion"].value
      ).getFullYear(),
      month:
        new Date(this.addForm.controls["yearOfCompletion"].value).getMonth() +
        1,
      day: new Date(this.addForm.controls["yearOfCompletion"].value).getDate(),
    };
  }
  ...
  setMinDate() {
    this.minDate = {
      year: new Date(
        this.addForm.controls["yearOfJoining"].value
      ).getFullYear(),
      month:
        new Date(this.addForm.controls["yearOfJoining"].value).getMonth() + 1,
      day: new Date(this.addForm.controls["yearOfJoining"].value).getDate(),
    };
  ...
  createFormGroup(): FormGroup {
    return this.formBuilder.group({
      ...
      degree: ["", [Validators.required, Validators.maxLength(32)]],
      percentage: [null, [Validators.required, Validators.max(100)]],
      specialization: ["", [Validators.required, Validators.maxLength(32)]],
      university: ["", [Validators.required, Validators.maxLength(32)]],
