...
CREATE TABLE IF NOT EXISTS hrms.leave (
		...
		employeeid integer NOT NULL REFERENCES hrms.HRMSEmployee(id),
		approvedby integer,
...
CREATE TABLE IF NOT EXISTS hrms.jobdetails (
		...
		reportingmanager integer REFERENCES hrms.HRMSEmployee(id),
...
CREATE TABLE IF NOT EXISTS hrms.employeesalaryconfigurationdetails (
		id SERIAL PRIMARY KEY,
		employeeid integer REFERENCES hrms.HRMSEmployee(id),
...
CREATE TABLE IF NOT EXISTS hrms.ondutynotifypersonnel (
		...
		notifypersonnel integer REFERENCES hrms.HRMSEmployee(id),
		createddate timestamp,
		modifieddate timestamp,
		createdby text,
		modifiedby text,
