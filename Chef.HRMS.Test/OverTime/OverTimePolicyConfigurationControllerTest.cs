...
namespace Chef.HRMS.Test
{
    public class OverTimePolicyConfigurationControllerTest : BaseTest
    {
        ...
        public async void Get_WhenCalled_ReturnsOkResult()
        {
            //Arrange
            var id = 2;
            mockService.Setup(repo => repo.GetAsync(It.IsAny<int>())).Returns(Task.FromResult(GetMockOverTimePolicyConfiguration()));
        ...
        {
            //Arrange
            mockService.Setup(repo => repo.GetAllAsync()).Returns(Task.FromResult(GetMockOverTimePolicyConfigurationList()));
        ...
        public async void Add_ValidObjectPassed_ReturnedResponseHasCreatedItem()
        {
            ...
            mockService.Setup(service => service.InsertAsync(It.IsAny<OverTimePolicyConfiguration>())).Returns(Task.FromResult(GetMockOverTimePolicyConfiguration()));
