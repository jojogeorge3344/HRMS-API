...
namespace Chef.HRMS.Test
{
    public class OverTimePolicyControllerTest : BaseTest
    {
        ...
        public async void Get_WhenCalled_ReturnsOkResult()
        {
            //Arrange
            var id = 2;
            mockService.Setup(repo => repo.GetAsync(It.IsAny<int>())).Returns(Task.FromResult(GetMockOverTimePolicy()));
        ...
        {
            //Arrange
            mockService.Setup(repo => repo.GetAllAsync()).Returns(Task.FromResult(GetMockOverTimePolicyList()));
        ...
        public async void Add_ValidObjectPassed_ReturnedResponseHasCreatedItem()
        {
            ...
            mockService.Setup(service => service.InsertAsync(It.IsAny<OverTimePolicy>())).Returns(Task.FromResult(GetMockOverTimePolicy()));
