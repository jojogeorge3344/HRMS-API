...
{
    public class PayrollComponentService : AsyncService, IPayrollComponentService
    {
        ...
        public async Task<PayrollComponent> InsertAsync(PayrollComponent payrollComponent)
        {
