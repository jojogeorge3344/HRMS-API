...
{
    public class EmployeeNumberSeriesServices : AsyncService, IEmployeeNumberSeriesServices
    {
        ...
        public async Task<EmployeeNumberSeries> InsertAsync(EmployeeNumberSeries employeeNumberSeries)
        {
