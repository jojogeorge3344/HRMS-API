...
{
    public class EducationDocumentService : AsyncService, IEducationDocumentService
    {
        ...
        public Task<EducationDocument> InsertAsync(EducationDocument educationDocument)
        {
